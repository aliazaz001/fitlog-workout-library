    ...
    <header className="sticky top-0 z-50 border-b border-[#1c1f26] bg-[#0c0d10]/95 backdrop-blur">
      <nav className="mx-auto flex h-16 max-w-[1280px] items-center justify-between px-6 lg:h-[81px]">
        <Link href="/" className="flex items-center gap-2">
          <img src="/logo.png" alt="FitLog" className="h-6 w-auto object-contain" />
        ...
        <div className="hidden items-center gap-5 text-[11px] md:flex">
          <Link
            ...
            className={
              !isPlanPage
                ? "rounded-full bg-[#ccff00] px-4 py-1.5 font-semibold text-black"
                : "px-4 py-1.5 font-medium text-white/65 transition hover:text-white"
            }
          >
            Workouts
          </Link>
        ...
        <div className="hidden items-center gap-5 text-[11px] md:flex">
          <Link href="/my-plan" className="font-medium text-white/65 transition hover:text-white">
            Plan
        ...
        <div className="border-t border-[#1c1f26] bg-[#0c0d10] px-6 py-5 md:hidden">
          <div className="flex flex-col gap-4 text-sm">
            <Link
              ...
              className={!isPlanPage ? "font-semibold text-[#ccff00]" : "text-white/70"}
            >
              Workouts
            </Link>
            ...
            <Link href="/my-plan" onClick={() => setMenuOpen(false)} className="text-white/70">
